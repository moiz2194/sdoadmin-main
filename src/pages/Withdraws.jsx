...
const Record = () => {
    ...
    const getallwithdraws = a.getallwithdraws;
    const updatewithdraw=a.updatewithdraw;
    ...
    function formatDateToDdmmyyyy(inputDate) {
      ...
      const handleapprove=(id)=>{
        updatewithdraw({id,status:"approve"})
      }  
      const handlereject=(id)=>{
        updatewithdraw({id,status:"reject"})
      }  
    return (
        <div className='container'>
            <h2 className='my-3'>Withdrawals</h2>
            {loading ? (
                <Loading/>
            ) : (
                <>
                        ...
                        >
                            ...
                            <div className="table-responsive">
                                <table className="table">
                                    ...
                                    <tbody>
                                        {withdraws?.pending?.map((withdraw) => (
                                            <tr key={withdraw.id}>
                        ...
                        >
                            ...
                            <div className="table-responsive">
                                <table className="table">
                                    ...
                                    <tbody>
                                        {withdraws.rejected.map((withdraw) => (
                                            <tr key={withdraw.id}>
                                                <td>{formatDateToDdmmyyyy(withdraw.createdAt)}</td>
                                                <td>{withdraw.amount}</td>
                                                <td>{formatTimeTo12hr(withdraw.createdAt)}</td>
                        ...
                        >
                            ...
                            <div className="table-responsive">
                                <table className="table">
                                    ...
                                    <tbody>
                                        {withdraws.approved.map((withdraw) => (
                                            <tr key={withdraw.id}>
                                                <td>{formatDateToDdmmyyyy(withdraw.createdAt)}</td>
                                                <td>{withdraw.amount}</td>
                                                <td>{formatTimeTo12hr(withdraw.createdAt)}</td>
